...
namespace HumaneSociety
{
    class Admin : User
    {
        ...
        private void UpdateEmployee()
        {
            ...
            try
            {
                Query.RunEmployeeQueries(employee, "update");//write
        ...
        private void ReadEmployee()
        {
            try
            {
                ...
                Query.RunEmployeeQueries(employee, "read");//write
            }
            catch
            {
                Console.Clear();
        ...
        private void RemoveEmployee()
        {
            ...
            {
                Console.Clear();
                Query.RunEmployeeQueries(employee, "delete");//write
        ...
        private void AddEmployee()
        {
            ...
            try
            {
                Query.RunEmployeeQueries(employee, "create");//write
