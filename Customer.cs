...
namespace HumaneSociety
{
    class Customer : User
    {
        ...
        private void ApplyForAdoption()
        {
            ...
            var animal = Query.GetAnimalByID(iD); //write
            ...
            {
                Query.Adopt(animal, client); //write
        ...
        public static string GetUserName()
        {
            ...
            var clients = Query.GetClients(); //write
        ...
        private static int GetState()
        {
            ...
            var states = Query.GetStates(); //write
        ...
        public bool CreateClient()
        {
            try
            {
                ...
                Query.AddNewClient(firstName, lastName, username, password, email, streetAddress, zipCode, stateId); //write
                Console.Clear();
        ...
        private void UpdatePassword()
        {
            ...
            Query.UpdateClient(client);//write
        }
